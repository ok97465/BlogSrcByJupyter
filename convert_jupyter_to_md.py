...
if __name__ == '__main__':
    if 1:
        tags_in_ipynb = []
        folder_github_page = '/home/ok97465/private/ok97465.github.io'
        for pathname in glob.iglob('/home/ok97465/private/BlogSrcByJupyter/Math/*.ipynb', recursive=True):
            header = convert_ipynb_to_post(pathname, folder_github_page, b_numbering=True)
            tags_in_ipynb.extend(header.tags)
        for pathname in glob.iglob('/home/ok97465/private/BlogSrcByJupyter/Python/*.ipynb', recursive=True):
            header = convert_ipynb_to_post(
                pathname, folder_github_page, b_numbering=True)
            tags_in_ipynb.extend(header.tags)
        for pathname in glob.iglob('/home/ok97465/private/BlogSrcByJupyter/QuickNotes/*.ipynb', recursive=True):
            header = convert_ipynb_to_post(
        ...
        copy_tree(
            '/home/ok97465/private/BlogSrcByJupyter/assets', folder_github_page+'/assets')
